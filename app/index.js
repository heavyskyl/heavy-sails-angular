...
var HeavySailsGenerator = module.exports = function HeavySailsGenerator(args, options) {
...
util.inherits(HeavySailsGenerator, yeoman.generators.Base);

HeavySailsGenerator.prototype.welcome = function welcome() {
  // welcome message
...
HeavySailsGenerator.prototype.askForCompass = function askForCompass() {
  var cb = this.async();
  this.prompt([{
    type : 'string',
    name : 'assets',
...
HeavySailsGenerator.prototype.askForBootstrap = function askForBootstrap() {
...
HeavySailsGenerator.prototype.askForModules = function askForModules() {
  var cb = this.async();
...
HeavySailsGenerator.prototype.readIndex = function readIndex() {
  this.ngRoute = this.env.options.ngRoute;
  this.indexFile = this.engine(this.read('../../templates/common/index.html'), this);
};

HeavySailsGenerator.prototype.bootstrapFiles = function bootstrapFiles() {
...
HeavySailsGenerator.prototype.appJs = function appJs() {
...
HeavySailsGenerator.prototype.createIndexHtml = function createIndexHtml() {
  this.indexFile = this.indexFile.replace(/&apos;/g, "'");
  this.write(path.join(this.appPath, 'index.html'), this.indexFile);
};

HeavySailsGenerator.prototype.packageFiles = function () {
...
HeavySailsGenerator.prototype.imageFiles = function () {
  this.sourceRoot(path.join(__dirname, 'templates'));
  this.directory('images', 'app/images', true);
};

HeavySailsGenerator.prototype._injectDependencies = function _injectDependencies() {
  var howToInstall =
